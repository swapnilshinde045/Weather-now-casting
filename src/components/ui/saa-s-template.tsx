...
export const Button = React.forwardRef<HTMLButtonElement, ButtonProps>(
  ({ variant = "default", size = "default", className = "", children, ...props }, ref) => {
    ...
    const variants = {
      ...
      gradient: "bg-gradient-to-b from-white via-white/95 to-white/60 text-black hover:scale-105 active:scale-95 shadow-lg shadow-white/10"
    };
...
export const Hero = React.memo(() => {
  return (
    <section
      className="relative flex flex-col items-center justify-start px-6 py-20 md:py-24"
      style={{
